    ...
    return (
        <div className="job shadow-lg rounded-lg p-6 bg-white lg:w-[30%] my-4 border">
            <div className="profile-info mb-4">
                ...
                <p className="text-gray-600 font-semibold">{info.description}</p>
            </div>
            ...
            <div className="actions mt-4 flex justify-between">
                <button className="bg-[#19995c] font-bold text-white py-2 px-4 rounded hover:bg-green-700">
                    Apply Now
                </button>
                <button className="bg-gray-300 font-bold text-gray-700 py-2 px-4 rounded hover:bg-gray-400">
                    Save for Later
                </button>
            </div>
        </div>
