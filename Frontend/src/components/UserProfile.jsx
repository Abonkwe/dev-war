    ...
    <div className="max-w-3xl mx-auto mt-10 p-6 bg-white shadow-lg rounded-xl text-center">
      ...
      <div className="flex items-center justify-between border-b pb-4">
        <div className="flex items-center">
          <img src="/profile.jpg" alt="Profile" className="w-16 h-16 rounded-full object-cover border-2 border-gray-300" />
        ...
        <Link to="/profile"> <button className="px-4 py-2 bg-[#19995c] text-white rounded-md hover:bg-[#19995be8] transition">Edit</button></Link>
          <button className="px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 transition">Delete</button>
        </div>
      </div>

      {/* Tabs Navigation */}
      <div className="flex justify-center mt-5 space-x-5 border-b pb-3">
        <button
          className={`py-2 px-4 rounded-md ${activeTab === "active" ? "bg-green-500 text-white" : "bg-gray-200"}`}
          onClick={() => setActiveTab("active")}
        >
          Active Jobs
        </button>
        <button
          className={`py-2 px-4 rounded-md ${activeTab === "posted" ? "bg-blue-500 text-white" : "bg-gray-200"}`}
          onClick={() => setActiveTab("posted")}
        >
          Posted Jobs
        </button>
        <button
          className={`py-2 px-4 rounded-md ${activeTab === "completed" ? "bg-yellow-500 text-white" : "bg-gray-200"}`}
      ...
      {/* Scrollable Job List */}
      <div className="mt-5 h-[250px] overflow-y-auto p-3 border border-gray-300 rounded-lg">
        {activeTab === "active" && (
          <div>
